...
export default function ProposerNote() {
  return (
    <section className="bg-white dark:bg-[#0F0F0F] py-16 border-t border-[#E2DDD6] dark:border-[#2A2A2A]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="grid sm:grid-cols-5 gap-8 items-start rounded-2xl border border-[#E2DDD6] dark:border-[#2A2A2A] bg-[#FAF7F2] dark:bg-[#1A1A1A] p-7 sm:p-9"
        >
          {/* Left: proposer note */}
          <div className="sm:col-span-3 flex flex-col gap-4">
            ...
            {/* Note body */}
            <div className="space-y-3 text-sm text-[#555555] dark:text-[#AAAAAA] leading-relaxed" style={{ wordBreak: 'keep-all' }}>
              <p>
            ...
            <div className="pt-2 border-t border-[#E2DDD6] flex flex-col gap-0.5">
              <span className="text-sm font-bold text-[#1F1F1F] dark:text-[#F0F0F0]">박용환</span>
          ...
          <div className="sm:col-span-1 flex flex-col gap-4">
            ...
            <p className="text-xs text-[#555555] dark:text-[#AAAAAA] leading-relaxed" style={{ wordBreak: 'keep-all' }}>
